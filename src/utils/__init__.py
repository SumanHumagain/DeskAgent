"""
Utility modules and functions for Desktop Automation Agent
Combines admin elevation with general utility functions
"""

import os
from pathlib import Path

# Import admin elevation functionality
from .admin_elevation import AdminElevation, is_admin, require_admin

# General utility functions (from old utils.py for backward compatibility)
